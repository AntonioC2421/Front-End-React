        ...
        <div className="Home row">
            <div className="CardPresentacion py-3 col-lg-4 col-md-12 col-sm-12">
                ...
                <div class="card-client">
                    ...
                    <p class="name-client"> Antonio Cotrina
            ...
            <div className="presentacionProyect p-3 col-lg-8 col-md-12 col-sm-12">
                ...
                <p className="descripcionproyecto">
                    ...
                    <dl>
                        <dt>Back-End:</dt>
                        <dd>Python con Flask, encargado de gestionar los endpointd de la API y la logica de negocio.</dd>
                        <dt>Base de Datos:</dt>
                    ...
                    <dl>
                        <dt>Gestíon de Datos:</dt>
                        <dd>Permite realizar operaciones de Crear, Leer, Actualizar y Eliminar (CRUD) sobre los datos almacenados.</dd>
                        <dt>Separacion de Responsabilidades:</dt>
                        <dd>La API se encuentra en una carpeta distinta al Front-End, permitiendo escabilidad y mantenimiento independiente.</dd>
